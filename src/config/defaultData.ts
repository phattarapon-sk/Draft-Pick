...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    config: {
      ...
      timer: { x: 885, y: 35, width: 150, height: 95 },
      phaseIndicator: { x: 835, y: 135, width: 250, height: 42 },
      blueTeamHeader: { x: 28, y: 40, width: 735, height: 95 },
      redTeamHeader: { x: 1157, y: 40, width: 735, height: 95 },
      blueScore: { x: 790, y: 40, width: 105, height: 95 },
      redScore: { x: 1025, y: 40, width: 105, height: 95 },
      sponsors: { x: 835, y: 975, width: 250, height: 65 },
      decorations: {
        centerVsText: true,
        showGridLines: true,
        showScanlines: true,
  ...
  },
  {
    ...
    config: {
      ...
      timer: { x: 885, y: 35, width: 150, height: 95 },
      phaseIndicator: { x: 835, y: 145, width: 250, height: 42 },
      blueTeamHeader: { x: 28, y: 45, width: 735, height: 90 },
      redTeamHeader: { x: 1157, y: 45, width: 735, height: 90 },
      blueScore: { x: 790, y: 45, width: 105, height: 90 },
      redScore: { x: 1025, y: 45, width: 105, height: 90 },
      sponsors: { x: 835, y: 960, width: 250, height: 65 },
      decorations: {
        centerVsText: true,
        showGridLines: true,
        showScanlines: true,
