...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    config: {
      ...
      heroSlots: [
        { id: 'slot-blue-pick-0', team: 'blue', type: 'pick', slotIndex: 0, x: 40, y: 190, width: 140, height: 600 },
        { id: 'slot-blue-pick-1', team: 'blue', type: 'pick', slotIndex: 1, x: 190, y: 190, width: 140, height: 600 },
        { id: 'slot-blue-pick-2', team: 'blue', type: 'pick', slotIndex: 2, x: 340, y: 190, width: 140, height: 600 },
        { id: 'slot-blue-pick-3', team: 'blue', type: 'pick', slotIndex: 3, x: 490, y: 190, width: 140, height: 600 },
        { id: 'slot-blue-pick-4', team: 'blue', type: 'pick', slotIndex: 4, x: 640, y: 190, width: 140, height: 600 },

        { id: 'slot-red-pick-0', team: 'red', type: 'pick', slotIndex: 0, x: 1140, y: 190, width: 140, height: 600 },
        { id: 'slot-red-pick-1', team: 'red', type: 'pick', slotIndex: 1, x: 1290, y: 190, width: 140, height: 600 },
        { id: 'slot-red-pick-2', team: 'red', type: 'pick', slotIndex: 2, x: 1440, y: 190, width: 140, height: 600 },
        { id: 'slot-red-pick-3', team: 'red', type: 'pick', slotIndex: 3, x: 1590, y: 190, width: 140, height: 600 },
        { id: 'slot-red-pick-4', team: 'red', type: 'pick', slotIndex: 4, x: 1740, y: 190, width: 140, height: 600 },

        { id: 'slot-blue-ban-0', team: 'blue', type: 'ban', slotIndex: 0, x: 370, y: 830, width: 95, height: 95 },
        { id: 'slot-blue-ban-1', team: 'blue', type: 'ban', slotIndex: 1, x: 475, y: 830, width: 95, height: 95 },
        { id: 'slot-blue-ban-2', team: 'blue', type: 'ban', slotIndex: 2, x: 580, y: 830, width: 95, height: 95 },
        { id: 'slot-blue-ban-3', team: 'blue', type: 'ban', slotIndex: 3, x: 685, y: 830, width: 95, height: 95 },

        { id: 'slot-red-ban-0', team: 'red', type: 'ban', slotIndex: 0, x: 1140, y: 830, width: 95, height: 95 },
        { id: 'slot-red-ban-1', team: 'red', type: 'ban', slotIndex: 1, x: 1245, y: 830, width: 95, height: 95 },
        { id: 'slot-red-ban-2', team: 'red', type: 'ban', slotIndex: 2, x: 1350, y: 830, width: 95, height: 95 },
        { id: 'slot-red-ban-3', team: 'red', type: 'ban', slotIndex: 3, x: 1455, y: 830, width: 95, height: 95 },
      ],
      timer: { x: 860, y: 35, width: 200, height: 95 },
      phaseIndicator: { x: 760, y: 135, width: 400, height: 42 },
      blueTeamHeader: { x: 40, y: 40, width: 615, height: 95 },
      redTeamHeader: { x: 1265, y: 40, width: 615, height: 95 },
      blueScore: { x: 670, y: 40, width: 95, height: 95 },
      redScore: { x: 1155, y: 40, width: 95, height: 95 },
      sponsors: { x: 760, y: 975, width: 400, height: 65 },
      decorations: {
        centerVsText: true,
        showGridLines: true,
        showScanlines: true,
  ...
  },
  {
    ...
    config: {
      ...
      heroSlots: [
        { id: 'slot-blue-pick-0', team: 'blue', type: 'pick', slotIndex: 0, x: 40, y: 220, width: 140, height: 550 },
        { id: 'slot-blue-pick-1', team: 'blue', type: 'pick', slotIndex: 1, x: 190, y: 220, width: 140, height: 550 },
        { id: 'slot-blue-pick-2', team: 'blue', type: 'pick', slotIndex: 2, x: 340, y: 220, width: 140, height: 550 },
        { id: 'slot-blue-pick-3', team: 'blue', type: 'pick', slotIndex: 3, x: 490, y: 220, width: 140, height: 550 },
        { id: 'slot-blue-pick-4', team: 'blue', type: 'pick', slotIndex: 4, x: 640, y: 220, width: 140, height: 550 },

        { id: 'slot-red-pick-0', team: 'red', type: 'pick', slotIndex: 0, x: 1140, y: 220, width: 140, height: 550 },
        { id: 'slot-red-pick-1', team: 'red', type: 'pick', slotIndex: 1, x: 1290, y: 220, width: 140, height: 550 },
        { id: 'slot-red-pick-2', team: 'red', type: 'pick', slotIndex: 2, x: 1440, y: 220, width: 140, height: 550 },
        { id: 'slot-red-pick-3', team: 'red', type: 'pick', slotIndex: 3, x: 1590, y: 220, width: 140, height: 550 },
        { id: 'slot-red-pick-4', team: 'red', type: 'pick', slotIndex: 4, x: 1740, y: 220, width: 140, height: 550 },

        { id: 'slot-blue-ban-0', team: 'blue', type: 'ban', slotIndex: 0, x: 370, y: 810, width: 95, height: 95 },
        { id: 'slot-blue-ban-1', team: 'blue', type: 'ban', slotIndex: 1, x: 475, y: 810, width: 95, height: 95 },
        { id: 'slot-blue-ban-2', team: 'blue', type: 'ban', slotIndex: 2, x: 580, y: 810, width: 95, height: 95 },
        { id: 'slot-blue-ban-3', team: 'blue', type: 'ban', slotIndex: 3, x: 685, y: 810, width: 95, height: 95 },

        { id: 'slot-red-ban-0', team: 'red', type: 'ban', slotIndex: 0, x: 1140, y: 810, width: 95, height: 95 },
        { id: 'slot-red-ban-1', team: 'red', type: 'ban', slotIndex: 1, x: 1245, y: 810, width: 95, height: 95 },
        { id: 'slot-red-ban-2', team: 'red', type: 'ban', slotIndex: 2, x: 1350, y: 810, width: 95, height: 95 },
        { id: 'slot-red-ban-3', team: 'red', type: 'ban', slotIndex: 3, x: 1455, y: 810, width: 95, height: 95 },
      ],
      timer: { x: 860, y: 35, width: 200, height: 95 },
      phaseIndicator: { x: 760, y: 145, width: 400, height: 42 },
      blueTeamHeader: { x: 40, y: 45, width: 615, height: 90 },
      redTeamHeader: { x: 1265, y: 45, width: 615, height: 90 },
      blueScore: { x: 670, y: 45, width: 95, height: 90 },
      redScore: { x: 1155, y: 45, width: 95, height: 90 },
      sponsors: { x: 760, y: 960, width: 400, height: 65 },
      decorations: {
        centerVsText: true,
        showGridLines: true,
        showScanlines: true,
